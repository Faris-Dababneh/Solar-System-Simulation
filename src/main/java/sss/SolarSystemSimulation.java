...
public class SolarSystemSimulation extends Application {
    ...
    private static final Venus venus = new Venus();
    private static final Planet mars = new Planet(30, 1100, 1.5, 0.01, "mars");
    private static final Planet jupiter = new Planet(88, 1300, 10, 0.01, "jupiter");
    private static final Planet saturn = new Planet(75, 1550, 3.2, 0.008, "saturn");
    private static final Planet uranus = new Planet(62, 1750, 2.6, -0.007, "uranus");
    private static final Planet neptune = new Planet(61, 1950, 2.2, 0.006, "neptune");
    ...
    public void start(Stage stage) throws IOException {
        ...
        system.getChildren().addAll(venus.prepareVenus());
        system.getChildren().addAll(mars.prepareplanet());
        system.getChildren().addAll(jupiter.prepareplanet());
        system.getChildren().addAll(saturn.prepareplanet());
        system.getChildren().addAll(uranus.prepareplanet());
        system.getChildren().addAll(neptune.prepareplanet());
        ...
        root.getChildren().addAll(UI.createControls(system, earth, sun, mercury, venus, mars, jupiter, saturn, uranus, neptune));
