...
public class Sun {
    ...
    private final Sphere sun = new Sphere(175);
    ...
    public Node[] prepareSun() {
        ...
        sunMaterial.setSelfIlluminationMap(new Image(String.valueOf(new File("E:\\VSCODE PROJECTS\\Solar-System-Simulation\\src\\main\\java\\resources\\sun-map.jpg"))));
        ...
        axisMat.setSelfIlluminationMap(new Image(String.valueOf(new File("E:\\VSCODE PROJECTS\\Solar-System-Simulation\\src\\main\\java\\resources\\red.PNG"))));
